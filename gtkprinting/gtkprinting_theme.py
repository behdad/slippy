...
def prepare_page (renderer):
	...
	renderer.put_image ("Printer_in_1568-ce.png", width = width)

	cr.save ()
	cr.rotate (math.pi / 2)
	cr.move_to ((height-p2) / 2, - width)
	cr.set_source_rgb (0, 0, 0)
	renderer.put_text ("OpenPrinting Summit, Montréal, September 25, 2007", height=f-p2, valign=+1)
	cr.restore ()

	# Red Hat logos at the top
	cr.move_to (p, p)
